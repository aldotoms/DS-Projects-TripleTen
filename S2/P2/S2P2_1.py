...
def clean_user(user_info, user_name_1, user_age_1):
    user_name_1 = user_info[1].strip().replace('_',' ')
    user_age_1 = int(user_info[2])
    user_name_1 = user_name_1.split()
    
    user_info = ['32415', ' mike_reed ', 32.0, ['ELECTRONICS', 'SPORT', 'BOOKS'], [894, 213, 173]]
    user_info = [f"'32415', {user_name_1}, {user_age_1},['ELECTRONICS', 'SPORT', 'BOOKS'], [894, 213, 173]"]

    return user_info

test_user = ['32415', ' mike_reed ', 32.0, ['ELECTRONICS', 'SPORT', 'BOOKS'], [894, 213, 173]]
name_index = test_user[1]
age_index = test_user[2]
