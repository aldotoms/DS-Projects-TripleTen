# Capítulo 6/6 · Faltan 2 lecciones
# Proyecto
...
# ¡Felicidades! Has terminado el sprint sobre análisis exploratorio de datos. 
# Es momento de aplicar el conocimiento y las habilidades que adquiriste en un estudio de caso de análisis.
# Cuando hayas terminado el proyecto, envía tu trabajo al equipo de revisión en la plataforma para que lo evalúen. 
# Te darán su feedback en 48 horas. Realiza los cambios según los comentarios que recibiste, y luego envía la nueva versión de vuelta al equipo de revisión.
...
#   /datasets/aisles.csv, 
#   /datasets/departments.csv y 
#   /datasets/order_products.csv) 
# y echa un vistazo al contenido general de cada tabla.
...
# Mira los archivos CSV para tener una idea de cuáles deberían ser esos argumentos.

# Ten en cuenta que order_products.csv contiene muchas filas de datos. Cuando un DataFrame tiene demasiadas filas, info() no imprimirá los recuentos no nulos por defecto. 
# Si quieres imprimir los recuentos no nulos, incluye show_counts=True cuando llames a info().
